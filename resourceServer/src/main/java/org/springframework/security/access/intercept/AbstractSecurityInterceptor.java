...
public abstract class AbstractSecurityInterceptor implements InitializingBean,
	...
	private @Autowired ResourceServerTokenServices tokenServices;
	...
	protected InterceptorStatusToken beforeInvocation(Object object) {
		...
		Authentication authenticated = authenticateIfRequired(object);
	 ...
	 */
	private Authentication authenticateIfRequired(Object object) {
		FilterInvocation fi = (FilterInvocation)object;
		String token = fi.getRequest().getParameter("token");
